...
/**
* @param *ecran Ecran
* @param *imageDeFond Background
* @param *solo Solo Button Shape
* @param *multi Multiplayer Button Shape
* @param *sett Settings Button Shape
* @param *cred Credits Button Shape
* @param *exit Exit Button Shape
* @param *Volume Volume Button Shape


* @param continuer Game Menu ON/OFF
* @param continuer0 Options Menu ON/OFF
* @param so Solo Mode
* @param mp Multiplayer Mode
* @param cr Credits
* @param se Settings
* @param ex Exit
* @param z Volume
...

{
    ...
    int continuer = 1,continuer0= 1 ;
    int so=0,mp=0,cr=0,se=0,ex=0;
    int z =128 ;
    int x = 0 ;
