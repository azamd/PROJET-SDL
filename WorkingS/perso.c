...
perso->fond00 = IMG_Load("../game/perso/00.png");
perso->fond0 = IMG_Load("../game/perso/0.png");
perso->fond1 = IMG_Load("../game/perso/1.png");
perso->fond2 = IMG_Load("../game/perso/2.png");
perso->fond3 = IMG_Load("../game/perso/3.png");
perso->fonda = IMG_Load("../game/perso/a.png");
perso->fondb = IMG_Load("../game/perso/b.png");
perso->fondc = IMG_Load("../game/perso/c.png");
}
...
perso mouvement(perso perso,SDL_Rect camera,int d,int q,int z,int s,escalier escalier,int prevd,int prevq,int *saut,int jump)
{
int C;
...
vie->position2.x = 0 ;
vie->position2.y = 0 ;
vie->fond1 = IMG_Load("../game/perso/v1.png");
vie->fond2 = IMG_Load("../game/perso/v2.png");
vie->fond3 = IMG_Load("../game/perso/v3.png");
vie->fond4 = IMG_Load("../game/perso/v4.png");
vie->fond5 = IMG_Load("../game/finlvl/GameOver.png");
}
