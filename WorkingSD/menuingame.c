...
bout=IMG_Load("bout.png") ;
bouts=IMG_Load("bouts.png") ;
while (continuer1)
{
SDL_PollEvent(&event);
switch(event.type)
...
void menuingame2(int *continuer,perso perso,vie vie,int saut,SDL_Rect camera,SDL_Surface *ecran)
{
...
void menuingame3(int *continuer,perso perso,vie vie,int saut,SDL_Rect camera,SDL_Surface *ecran)
{
int n=1,continuer0=1,continuer1=1;
SDL_Surface *bout=NULL,*bouts=NULL;
SDL_Rect pos;
