...
ennemi->fond = IMG_Load("../assets/characters/warning.png");
ennemi->fond1 = IMG_Load("../assets/characters/x1.png");
ennemi->fond2 = IMG_Load("../assets/characters/x2.png");
ennemi->fonda = IMG_Load("../assets/characters/xa.png");
ennemi->fondb = IMG_Load("../assets/characters/xb.png");
}
